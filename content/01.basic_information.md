...
* Grades will be assigned based on several types of deliverables:
  ...
  * Course project (4-credit students only): 25% of final grade: 5% for literature review, 15% for Kaggle competition, 2.5% for exploratory data analysis, 7.5% for final presentation, and 10% for final report.
